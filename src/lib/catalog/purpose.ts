...
export const purposeCategories: Category[] = [
  ...
  },
  {
    ...
    h1: 'Инструмент и расходные материалы',
    title: 'Инструмент и расходные материалы для монтажа',
    description: 'Монтажный инструмент, уплотнители и расходные материалы для инженерной сантехники.',
    intro: 'Инструмент и расходные материалы: пресс-инструмент, ножницы, сварочное оборудование, уплотнители и монтажные принадлежности.',
    ...
    faq: [
      { question: 'Что находится в этом разделе?', answer: 'Инструмент для монтажа труб и расходные материалы для соединений и ремонта.' },
